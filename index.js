...
(window.litElementVersions||(window.litElementVersions=[])).push("2.2.1");const it=t=>t.flat?t.flat(1/0):function t(e,r=[]){for(let i=0,s=e.length;i<s;i++){const s=e[i];Array.isArray(s)?t(s,r):r.push(s)}return r}(t);class st extends J{static finalize(){super.finalize.call(this),this._styles=this.hasOwnProperty(JSCompiler_renameProperty("styles",this))?this._getUniqueStyles():this._styles||[]}static _getUniqueStyles(){const t=this.styles,e=[];if(Array.isArray(t)){it(t).reduceRight((t,e)=>(t.add(e),t),new Set).forEach(t=>e.unshift(t))}else t&&e.push(t);return e}initialize(){super.initialize(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow({mode:"open"})}adoptStyles(){const t=this.constructor._styles;0!==t.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?Q?this.renderRoot.adoptedStyleSheets=t.map(t=>t.styleSheet):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(t.map(t=>t.cssText),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(t){super.update(t);const e=this.render();e instanceof y&&this.constructor.render(e,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach(t=>{const e=document.createElement("style");e.textContent=t.cssText,this.renderRoot.appendChild(e)}))}render(){}}st.finalized=!0,st.render=(t,e,r)=>{if(!r||"object"!=typeof r||!r.scopeName)throw new Error("The `scopeName` option is required.");const i=r.scopeName,n=T.has(e),o=R&&11===e.nodeType&&!!e.host,a=o&&!F.has(i),p=a?document.createDocumentFragment():e;if(((t,e,r)=>{let i=T.get(e);void 0===i&&(s(e,e.firstChild),T.set(e,i=new w(Object.assign({templateFactory:E},r))),i.appendInto(e)),i.setValue(t),i.commit()})(t,p,Object.assign({templateFactory:L(i)},r)),a){const t=T.get(p);T.delete(p);const r=t.value instanceof g?t.value.template:void 0;q(i,p,r),s(e,e.firstChild),e.appendChild(p),T.set(e,t)}!n&&o&&window.ShadyCSS.styleElement(e.host)};const nt=t=>e=>{customElements.define(`gui-${t}`,e)};function ot(t){return function(t){return`${t[0].toUpperCase()}${t.slice(1)}`}(function(t,e){return t.replace(/([^A-Z\d])([A-Z\d]+)/g,`$1${e}$2`).toLowerCase()}(`${t}`," ")).replace(/[-_\s]+/g," ")}function at(t){return void 0===t?"":`${t}`}class pt extends st{on(t,e,...r){return this.addEventListener(t,e,...r),this}off(t,e,...r){return this.removeEventListener(t,e,...r),this}}pt.styles=rt`
  ...
  `;class lt extends Event{constructor(t,e){super("update",{composed:!0}),this.value=t,this.previous=e}}class dt extends pt{constructor({value:t,disabled:e=!1}={}){super(),this.set(t),this.disabled=e}input(t){t.stopPropagation();const e=this.value;Promise.resolve(this.parse(this.extract(t))).then(t=>this.set(t).dispatchEvent(new lt(this.value,e)))}extract(t){return t.target.value}parse(t){return t}set(t){return this.value=t,this}static match(t){return this.types.some(e=>e.match(t))}static register(t){return this.types.unshift(t),this}static from(t){return new(this.types.find(e=>e.match(t))||this.types[this.types.length-1])(t)}}dt.types=[],dt.styles=rt`
    ${pt.styles}
  ...
  `,t([G()],dt.prototype,"value"),t([G({type:Boolean})],dt.prototype,"disabled");class ht extends pt{constructor({target:t,listen:e=!1,label:r}={}){super(),this.target=t,this.listen=e,this.label=r}attach(){return this.dettach()}dettach(){return this}}ht.styles=rt`
    ${pt.styles}
  ...
  `,t([G({type:Boolean,reflect:!0})],ct.prototype,"focused"),t([G({type:Boolean,reflect:!0})],ct.prototype,"inline"),t([G({type:Boolean,reflect:!0})],ct.prototype,"fluid"),ct=t([nt("value-controller")],ct);let mt=ut=class extends ht{constructor({open:t=!1,transparent:e=!1,flat:r=!1,...i}={}){super(i),this.transparent=!1,this.flat=!1,this._open=!1,this.childControllers=[],this._open=t,this.transparent=e,this.flat=r}get contentHeight(){return[...this.content.children].reduce((t,e)=>t+e.offsetHeight,0)}get open(){return this._open}set open(t){t!==this._open&&(clearTimeout(this.openTimeout),this._open=t,t?(this.content.style.height=`${this.contentHeight}px`,this.openTimeout=window.setTimeout(()=>{this.content.style.height=""},500)):(this.content.style.height||(this.content.style.height=`${this.contentHeight}px`),requestAnimationFrame(()=>{this.content.style.height="0"})))}resolve(t,e){if("string"!=typeof t)return{target:e||this.target,property:t};let r=t.split(".");return{property:r.pop(),target:r.reduce((t,e)=>t&&"object"==typeof t&&t[e]||void 0,e||this.target)}}firstUpdated(){this.open||(this.content.style.height="0")}attach(){return super.attach(),this.childControllers.forEach(t=>t.attach()),this}dettach(){return super.dettach(),this.childControllers.forEach(t=>t.dettach()),this}add(t,e,r){let i;if(t instanceof ht)i=t;else{let r;if("string"==typeof t){r="object"==typeof e?{...e}:{};const{target:i,property:s}=this.resolve(t,r.target);r={...r,target:i,property:s}}else r={target:this.target,...t};i=new ct(r)}return"function"==typeof e&&(r=e),r&&r(i),this.childControllers.push(i),this}group(t,e,r){let i;if("object"==typeof t)i=t;else{const{target:r,property:s}=this.resolve(t);i={target:r?r[s]:void 0,label:ot(`${s}`),..."object"==typeof e?e:null}}const s=new ut(i);return this.add(s),"function"==typeof e?e&&e(s):r&&r(s),this}remove(t){if(t){let e=this.childControllers.indexOf(t);-1!==e&&this.childControllers.splice(e,1)}return this}toggle(){return this.open=!this.open,this}render(){return V`
      <span
  ...
  `,t([G({type:String,reflect:!0})],gt.prototype,"scheme"),t([G({type:Boolean,reflect:!0})],gt.prototype,"fixed"),t([G({type:String,reflect:!0})],gt.prototype,"position"),t([G({type:Number})],gt.prototype,"width"),gt=t([nt("panel")],gt);let ft=class extends dt{constructor({maximumLength:t=-1,multiline:e=!1,...r}={}){super(r),this.maximumLength=t,this.multiline=e}render(){return this.multiline?V`
        <textarea
          .value=${at(this.value)}
      ...
      `:V`
        <input
          ...
          @input=${this.input}
        >
      `}static match({value:t}){return"string"==typeof t}};ft.styles=rt`
    ${dt.styles}
  ...
  `,t([G({type:Number})],ft.prototype,"maximumLength"),t([G({type:Boolean})],ft.prototype,"multiline"),ft=t([nt("text-field")],ft);const yt=rt`
  appearance: none;
...
`,vt=rt`
  ...
  height: 2px;
  border-radius: 2px;
`;let xt=class extends dt{constructor({minimum:t=-1/0,maximum:e=1/0,step:r,range:i=!0,...s}={}){super(s),this.minimum=t,this.maximum=e,this.step=r,this.range=i,this.displayValue=this.value}get inferedMinimum(){return this.range&&this.minimum===-1/0?0:this.minimum}get inferedMaximum(){return this.range&&this.maximum===1/0?100:this.maximum}parse(t){return Math.max(this.minimum,Math.min(this.maximum,parseFloat(t)||0))}render(){return V`
      ${this.range?V`
        <input
          type="range"
          .value=${this.value}
    ...
    `}static match({value:t}){return"number"==typeof t}};xt.styles=rt`
    ${dt.styles}
  ...
  `,t([Y('input[type="number"]')],xt.prototype,"$input"),t([G({type:Number,attribute:!1})],xt.prototype,"displayValue"),t([G({type:Number})],xt.prototype,"minimum"),t([G({type:Number})],xt.prototype,"maximum"),t([G({type:Number})],xt.prototype,"step"),t([G({type:Boolean,reflect:!0})],xt.prototype,"range"),xt=t([nt("number-field")],xt);const _t=["number","hex","rgb","array","object"],wt=/^\s*#?([a-f\d]{6}|[a-f\d]{3})\s*$/i,St=/^\s*rgb(?:a)?\s*\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*(?:,\s*([\d\.]+)\s*)?\)\s*$/i;function $t(t){return"number"==typeof t?t:parseFloat(t)}function kt(t){if(t)switch(typeof t){case"string":const e=t.match(St);return!(!e||!e[4]);case"object":return"number"==typeof t[3]||"number"==typeof t.a}return!1}function Ct(t){if(t)switch(typeof t){case"string":const e=t.match(St);if(e&&e[4])return parseFloat(e[4]);break;case"object":let r=NaN;if("number"==typeof t[3]&&(r=$t(t[3])),"number"==typeof t.a&&(r=$t(t.a)),!isNaN(r))return r}return 1}function Pt(t,e){switch(typeof t){case"number":if(~~t===t&&t>=0&&t<=16777215)return"number";break;case"string":if(wt.test(t))return"hex";if(St.test(t))return"rgb";break;case"object":if(t){if("number"==typeof t.r&&"number"==typeof t.g&&"number"==typeof t.b)return"object";if("number"==typeof t[0]&&"number"==typeof t[1]&&"number"==typeof t[2])return"array"}}return e}function Nt(t,e,r=!1){let i=0,s=0,n=0,o=1;switch(typeof t){case"string":let e=t.match(wt);if(!e){let e=t.match(St);e&&(i=parseInt(e[1],10),s=parseInt(e[2],10),n=parseInt(e[3],10),e[4]&&(o=parseFloat(e[4])));break}{let r=e[1];t=parseInt(6===r.length?r:`${r[0]}${r[0]}${r[1]}${r[1]}${r[2]}${r[2]}`,16)}case"number":i=t>>16&255,s=t>>8&255,n=255&t;break;case"object":t&&("r"in t||"g"in t||"b"in t||"a"in t?(i=$t(t.r)||0,s=$t(t.g)||0,n=$t(t.b)||0,o=$t(t.a)):(i=$t(t[0])||0,s=$t(t[1])||0,n=$t(t[2])||0,o=$t(t[3])),isNaN(o)&&(o=1))}switch(e){case"number":return i<<16|s<<8|n;case"hex":return`#${(i<<16|s<<8|n).toString(16).padStart(6,"0")}`;case"rgb":return r?`rgba(${i}, ${s}, ${n}, ${o})`:`rgb(${i}, ${s}, ${n})`;case"array":return r?[i,s,n,o]:[i,s,n];case"object":default:return r?{r:i,g:s,b:n,a:o}:{r:i,g:s,b:n}}}let At=class extends dt{constructor({value:t,format:e=Pt(t,"rgb"),alpha:r=kt(t),...i}={}){super(i),this.format=e,this.alpha=r,this.set(t),this.displayValue=Nt(this.value,"hex"),this.displayAlpha=Ct(this.value)}get includeAlpha(){return this.alpha&&"hex"!==this.format&&"number"!==this.format}parse(t){if(this.includeAlpha){let e=Nt(t,"object",!0);return e.a=Math.max(0,Math.min(1,parseFloat(this.$alpha.value)||0)),e}return t}extract(t){return t.target===this.$alpha?Nt(this.value,"hex"):t.target.value}set(t){return super.set(Nt(t,this.format,this.alpha)),this}render(){const t=Nt(this.value,"hex"),e=`rgba(255, 255, 255, ${1-Ct(this.value)})`;return V`
      <input
        type="text"
        .value=${this.displayValue}
        .disabled=${this.disabled}
        @input=${this.input}
        @blur=${()=>{this.displayValue="",requestAnimationFrame(()=>{this.displayValue=Nt(this.value,"hex")})}}
      >
      ...
      <input
        ...
        .value=${t}
        .disabled=${this.disabled}
        style=${`\n          background-color: ${Nt(this.value,"rgb",!0)};\n          background-image: linear-gradient(-45deg, ${e} 50%, transparent 50%, transparent 100%, ${e} 100%, ${e});\n        `}
        @input=${t=>{this.input(t),this.displayValue=Nt(this.value,"hex")}}
      >
      ...
      ${this.includeAlpha?V`
        <div>
          <input
            ...
            .step=${.01}
            @input=${this.input}
            @blur=${()=>{this.displayAlpha=Ct(this.value)}}
          >
        </div>
      `:""}
    `}static match({value:t,format:e=Pt(t)}){return function(t){return _t.includes(t)}(e)}};At.styles=rt`
    ${dt.styles}
  ...
  `,t([Y('input[type="number"]')],At.prototype,"$alpha"),t([G({type:String,attribute:!1})],At.prototype,"displayValue"),t([G({type:Number,attribute:!1})],At.prototype,"displayAlpha"),t([G({type:String})],At.prototype,"format"),t([G({type:Boolean})],At.prototype,"alpha"),At=t([nt("color-field")],At);let Et=class extends dt{constructor({options:t,humanize:e=!0,...r}={}){super(r),this.options=t,this.humanize=e}get labels(){if(!this.options)return[];let t=Array.isArray(this.options)?this.options.map(t=>`${t}`):Object.keys(this.options);return this.humanize&&t.forEach((e,r)=>{t[r]=ot(e)}),t}get values(){return this.options?Array.isArray(this.options)?this.options:Object.values(this.options):[]}parse(t){return this.values[t]}render(){return V`
      <select
        .disabled=${this.disabled}
        @input=${this.input}
      >
    ...
    `}static match({options:t}){return t&&"object"==typeof t}};Et.styles=rt`
    ${dt.styles}
  ...
  `,t([G({type:Object})],Et.prototype,"options"),t([G({type:Boolean})],Et.prototype,"humanize"),Et=t([nt("select-field")],Et);let zt=class extends dt{constructor(){super(...arguments),this.toggle=t=>this.$input.click()}extract(t){return t.target.checked}connectedCallback(){super.connectedCallback(),this.addEventListener("click",this.toggle)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("click",this.toggle)}render(){return V`
      <input
        type="checkbox"
        .checked=${this.value}
        .disabled=${this.disabled}
      ...
      >
    `}static match({value:t}){return"boolean"==typeof t}};zt.styles=rt`
    ${dt.styles}
  ...
  `,t([Y("input")],zt.prototype,"$input"),zt=t([nt("checkbox-field")],zt);let Tt=class extends dt{constructor({format:t="url",value:e,accept:r=(e instanceof File||e instanceof Blob?e.type:void 0),...i}={}){super(i),this.name="",this.format=t,this.accept=r,this.set(e)}extract(t){const e=t.target.files;return e?e[0]:null}parse(t){if(!t)return;switch(this.format){case"file":return t;case"url":return URL.createObjectURL(t)}const e=new Blob([t],{type:t.type});switch(this.format){case"text":return e.text();case"buffer":return e.arrayBuffer();case"stream":return e.stream()}return e}set(t){return!t&&this.$input&&(this.$input.value=""),t instanceof File||t instanceof Blob?this.name=t.name:"string"==typeof t&&(this.name=t),this.name||(this.name="Unknown file"),super.set(t)}clear(){const t=this.value;this.set(void 0),this.dispatchEvent(new lt(this.value,t))}render(){return V`
      ...
      ${this.value?V`<span
        @click=${this.clear}
      ></span>`:""}
    `}static match({value:t}){return t instanceof File||t instanceof Blob}};Tt.styles=rt`
    ${dt.styles}
  ...
  `,t([Y("input")],Tt.prototype,"$input"),t([G({type:String})],Tt.prototype,"format"),t([G({type:String})],Tt.prototype,"accept"),Tt=t([nt("file-field")],Tt);let Vt=class extends Tt{constructor(t={}){super({...t,accept:"image/*"})}set(t){return this.thumbnail&&(URL.revokeObjectURL(this.thumbnail),this.thumbnail=void 0),"string"==typeof t?this.thumbnail=t:(t instanceof Blob||t instanceof File)&&(this.thumbnail=URL.createObjectURL(t)),super.set(t)}render(){return V`
      <figure>
    ...
    `}static match(t){const e=t.value;return e&&"string"==typeof e&&/\.(png|jpe?g|gif|svg)$/i.test(e)||super.match(t)&&"image/"===e.type.slice(0,6)}};Vt.styles=rt`
    ${Tt.styles}
  ...
  `,t([G({type:String,attribute:!1})],Vt.prototype,"thumbnail"),Vt=t([nt("image-field")],Vt);let jt=class extends dt{constructor({args:t,...e}={}){if(super(e),t){this.parametersController=new mt({label:"Parameters",flat:!0,transparent:!0});const e=2+~~(Math.log(t.length-1)/Math.log(10));t.forEach((t,r)=>{const i=new ct({fluid:!0,label:`${r}`.padStart(e," "),...t});i.on("update",t=>t.stopPropagation()),this.parametersController.add(i)})}}trigger(){this.parametersController?this.value(...this.parametersController.childControllers.map(t=>t.value)):this.value()}render(){return V`
      ${this.parametersController?this.parametersController:""}
      <button .disabled=${this.disabled} @click=${this.trigger}>Trigger</button>
    `}static match({value:t}){return"function"==typeof t}};jt.styles=rt`
    ${dt.styles}
  ...
  `,jt=t([nt("method-field")],jt),dt.register(ft).register(At).register(xt).register(Et).register(zt).register(Tt).register(Vt).register(jt);const Ot={lorem:1,ipsum:"foo",dolor:new File([],"foo.txt"),sit:(t,e)=>alert(`${t} + ${e} = ${t+e}`),amet:{consectetur:!1,adipisicing:"rgba(35, 50, 75, 0.5)",elit:"https://picsum.photos/400/200.jpg"}},Ut=document.createElement("pre"),Mt=new gt({target:Ot,position:"top right",fixed:!0}).add("lorem").add("ipsum").add("dolor").add("sit",{label:"Add",args:[{value:1},{value:2}]}).group("amet",t=>t.add("consectetur").add("adipisicing").add("elit"));Mt.group({target:Mt,label:"GUI"},t=>t.add("scheme",{options:["auto","light","dark"]}).add("position",{options:["none","top left","top right","bottom left","bottom right"]}).add("fixed"));const Rt=()=>{Ut.textContent=JSON.stringify(Ot,null,2)};Mt.on("update",Rt),Rt();const Lt=document.createElement("style");Lt.textContent="\n  body {\n    background-color: #111;\n    margin: 0;\n    color: #eee;\n  }\n\n  pre {\n    padding: 20px;\n    margin: 0;\n    font-size: 20px;\n  }\n",document.head.appendChild(Lt),document.body.appendChild(Mt),document.body.appendChild(Ut)}();
