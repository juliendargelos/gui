...
`;let xe=class extends ue{constructor({minimum:e=-1/0,maximum:t=1/0,step:n,range:r=!0,...i}={}){super(i),this.minimum=e,this.maximum=t,this.step=n,this.range=r,this.displayValue=this.value}get inferedMinimum(){return this.range&&this.minimum===-1/0?0:this.minimum}get inferedMaximum(){return this.range&&this.maximum===1/0?100:this.maximum}parse(e){return Math.max(this.minimum,Math.min(this.maximum,parseFloat(e)||0))}render(){return T`
  ...
  `,t([Z('input[type="number"]')],Oe.prototype,"$alpha"),t([J({type:String,attribute:!1})],Oe.prototype,"displayValue"),t([J({type:Number,attribute:!1})],Oe.prototype,"displayAlpha"),t([J({type:String})],Oe.prototype,"format"),t([J({type:Boolean})],Oe.prototype,"alpha"),Oe=t([ae("color-field")],Oe);let Re=class extends ue{constructor({options:e,humanize:t=!0,...n}={}){super(n),this.options=e,this.humanize=t}get labels(){if(!this.options)return[];let e=Array.isArray(this.options)?this.options.map(e=>`${e}`):Object.keys(this.options);return this.humanize&&e.forEach((t,n)=>{e[n]=oe(t)}),e}get values(){return this.options?Array.isArray(this.options)?this.options:Object.values(this.options):[]}parse(e){return this.values[e]}render(){return T`
      <select
        .disabled=${this.disabled}
        @input=${this.input}
      >
