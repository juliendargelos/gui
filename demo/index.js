...
/**
   ...
   * subject to an additional IP rights grant found at
   * http://polymer.github.io/PATENTS.txt
   */;const A=new class{handleAttributeExpressions(e,t,n,r){const i=t[0];if("."===i){return new N(e,t.slice(1),n).parts}return"@"===i?[new C(e,t.slice(1),r.eventContext)]:"?"===i?[new S(e,t.slice(1),n)]:new x(e,t,n).parts}handleTextExpression(e){return new E(e)}};
/**
   * @license
   * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
   * This code may only be used under the BSD style license found at
...
/**
   ...
   * http://polymer.github.io/PATENTS.txt
   */
(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.1.2");const T=(e,...t)=>new y(e,t,"html",A)
/**
   * @license
   * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
   * This code may only be used under the BSD style license found at
   ...
   * subject to an additional IP rights grant found at
   * http://polymer.github.io/PATENTS.txt
   */;function j(e,t){const{element:{content:n},parts:r}=e,i=document.createTreeWalker(n,133,null,!1);let s=B(r),a=r[s],o=-1,l=0;const c=[];let d=null;for(;i.nextNode();){o++;const e=i.currentNode;for(e.previousSibling===d&&(d=null),t.has(e)&&(c.push(e),null===d&&(d=e)),null!==d&&l++;void 0!==a&&a.index===o;)a.index=null!==d?-1:a.index-l,s=B(r,s),a=r[s]}c.forEach(e=>e.parentNode.removeChild(e))}const L=e=>{let t=11===e.nodeType?0:1;const n=document.createTreeWalker(e,133,null,!1);for(;n.nextNode();)t++;return t},B=(e,t=-1)=>{for(let n=t+1;n<e.length;n++){const t=e[n];if(h(t))return n}return-1};
/**
   * @license
   * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
   * This code may only be used under the BSD style license found at
...
(window.litElementVersions||(window.litElementVersions=[])).push("2.2.1");const ie=e=>e.flat?e.flat(1/0):function e(t,n=[]){for(let r=0,i=t.length;r<i;r++){const i=t[r];Array.isArray(i)?e(i,n):n.push(i)}return n}(e);class se extends G{static finalize(){super.finalize.call(this),this._styles=this.hasOwnProperty(JSCompiler_renameProperty("styles",this))?this._getUniqueStyles():this._styles||[]}static _getUniqueStyles(){const e=this.styles,t=[];if(Array.isArray(e)){ie(e).reduceRight((e,t)=>(e.add(t),e),new Set).forEach(e=>t.unshift(e))}else e&&t.push(e);return t}initialize(){super.initialize(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow({mode:"open"})}adoptStyles(){const e=this.constructor._styles;0!==e.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?ee?this.renderRoot.adoptedStyleSheets=e.map(e=>e.styleSheet):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(e.map(e=>e.cssText),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(e){super.update(e);const t=this.render();t instanceof y&&this.constructor.render(t,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach(e=>{const t=document.createElement("style");t.textContent=e.cssText,this.renderRoot.appendChild(t)}))}render(){}}se.finalized=!0,se.render=(e,t,n)=>{if(!n||"object"!=typeof n||!n.scopeName)throw new Error("The `scopeName` option is required.");const r=n.scopeName,i=P.has(t),a=U&&11===t.nodeType&&!!t.host,o=a&&!V.has(r),l=o?document.createDocumentFragment():t;if(((e,t,n)=>{let r=P.get(t);void 0===r&&(s(t,t.firstChild),P.set(t,r=new E(Object.assign({templateFactory:R},n))),r.appendInto(t)),r.setValue(e),r.commit()})(e,l,Object.assign({templateFactory:z(r)},n)),o){const e=P.get(l);P.delete(l);const n=e.value instanceof m?e.value.template:void 0;H(r,l,n),s(t,t.firstChild),t.appendChild(l),P.set(t,e)}!i&&a&&window.ShadyCSS.styleElement(t.host)};const ae=e=>t=>{customElements.define(`gui-${e}`,t)};function oe(e){return function(e){return`${e[0].toUpperCase()}${e.slice(1)}`}(function(e,t){return e.replace(/([^A-Z\d])([A-Z\d]+)/g,`$1${t}$2`).toLowerCase()}(`${e}`," ")).replace(/[-_\s]+/g," ")}function le(e){return void 0===e?"":`${e}`}class ce extends se{on(e,t,...n){return this.addEventListener(e,t,...n),this}off(e,t,...n){return this.removeEventListener(e,t,...n),this}}ce.styles=re`
  ...
  `;class de extends Event{constructor(e,t){super("update",{composed:!0}),this.value=e,this.previous=t}}class ue extends ce{constructor({value:e,disabled:t=!1}={}){super(),this.set(e),this.disabled=t}input(e){e.stopPropagation();const t=this.value;Promise.resolve(this.parse(this.extract(e))).then(e=>this.set(e).dispatchEvent(new de(this.value,t)))}extract(e){return e.target.value}parse(e){return e}set(e){return this.value=e,this}static match(e){return this.types.some(({type:t})=>t.match(e))}static register(e,t){if(this.types.find(t=>e===t.name))throw new Error(`Field type ${e} has already been registered`);return this.types.unshift({type:t,name:e}),this}static from(e){return new((this.types.find(({type:t,name:n})=>n===e.field||t.match(e))||this.types[this.types.length-1]).type)(e)}}ue.types=[],ue.styles=re`
    ${ce.styles}
  ...
  `,t([J()],ue.prototype,"value"),t([J({type:Boolean})],ue.prototype,"disabled");class pe extends ce{constructor({target:e,listen:t=!1,label:n}={}){super(),this.target=e,this.listen=t,this.label=n}attach(){return this.dettach()}dettach(){return this}}pe.styles=re`
    ${ce.styles}
  ...
  `,t([J({type:String})],pe.prototype,"label");let he=class extends pe{constructor({field:e,property:t,inline:n=!0,fluid:r=!1,target:i,listen:s=!1,immediate:a=!0,label:o=(t?oe(`${t}`):void 0),value:l=(i&&t?i[t]:void 0),...c}){super({target:i,listen:s,label:o}),this.committing=!1,this.focused=!1,this.commit=this.commit.bind(this),this.property=t,this.inline=n,this.fluid=r,this.field=e instanceof ue?e:ue.from({value:l,field:e,...c}),this.field.on("focus",()=>{this.focused=!0}),this.field.on("blur",()=>{this.focused=!1}),this.attach(),a&&this.commit(new de(this.value,void 0))}get value(){return this.field.value}set value(e){this.field.set(e)}commit(e){this.target&&this.property&&(this.committing=!0,this.target[this.property]=e.value,this.committing=!1)}attach(){if(super.attach(),this.target&&this.property&&(this.field.on("update",this.commit),this.listen)){let e;this.descriptor=Object.getOwnPropertyDescriptor(this.target,this.property)||{value:void 0};const{get:t=(()=>e),set:n=(t=>{e=t})}=this.descriptor;try{Object.defineProperty(this.target,this.property,{get:t,set:e=>{const r=t();this.committing||this.field.set(e),n.call(this.target,e),this.dispatchEvent(new de(e,r))}})}catch(e){throw this.descriptor=void 0,new Error(`Unable to initialize property setter: ${e}`)}}return this}dettach(){if(super.dettach(),this.field.off("update",this.commit),this.target&&this.property&&this.descriptor){"value"in this.descriptor&&(this.descriptor.value=this.value);try{Object.defineProperty(this.target,this.property,this.descriptor),this.descriptor=void 0}catch(e){throw new Error(`Unable to dispose property setter: ${e}`)}}return this}render(){return T`${this.label?T`<span @mousedown=${e=>e.preventDefault()}>
          ${this.label}
  ...
  `,t([J({type:Boolean,reflect:!0})],he.prototype,"focused"),t([J({type:Boolean,reflect:!0})],he.prototype,"inline"),t([J({type:Boolean,reflect:!0})],he.prototype,"fluid"),he=t([ae("value-controller")],he);let fe=ge=class extends pe{constructor({open:e=!1,transparent:t=!1,flat:n=!1,...r}={}){super(r),this.transparent=!1,this._open=!1,this.flat=!1,this.childControllers=[],this._open=e,this.transparent=t,this.flat=n}get contentHeight(){return[...this.content.children].reduce((e,t)=>e+t.offsetHeight,0)}get open(){return this._open}set open(e){e!==this._open&&(clearTimeout(this.openTimeout),this._open=e,e?(this.content.style.height=`${this.contentHeight}px`,this.openTimeout=window.setTimeout(()=>{this.content.style.height=""},500)):(this.content.style.height||(this.content.style.height=`${this.contentHeight}px`),requestAnimationFrame(()=>{this.content.style.height="0"})))}resolve(e,t){if("string"!=typeof e)return{target:t||this.target,property:e};let n=e.split(".");return{property:n.pop(),target:n.reduce((e,t)=>e&&"object"==typeof e&&e[t]||void 0,t||this.target)}}firstUpdated(){this.open||(this.content.style.height="0")}attach(){return super.attach(),this.childControllers.forEach(e=>e.attach()),this}dettach(){return super.dettach(),this.childControllers.forEach(e=>e.dettach()),this}add(e,t,n){let r;if(e instanceof pe)r=e;else{let n;if("string"==typeof e){n="object"==typeof t?{...t}:{};const{target:r,property:i}=this.resolve(e,n.target);n={...n,target:r,property:i}}else n={target:this.target,...e};r=new he(n)}return"function"==typeof t&&(n=t),n&&n(r),this.childControllers.push(r),this.requestUpdate("childControllers",void 0),this}group(e,t,n){let r;if("object"==typeof e)r=e;else{const{target:n,property:i}=this.resolve(e);r={target:n?n[i]:void 0,label:oe(`${i}`),..."object"==typeof t?t:null}}const i=new ge(r);return"function"==typeof t?t&&t(i):n&&n(i),this.add(i),this}remove(e){if(e){let t=this.childControllers.indexOf(e);-1!==t&&this.childControllers.splice(t,1)}return this}toggle(){return this.open=!this.open,this}render(){return T`
      <span
  ...
  `,t([J({type:String,reflect:!0})],me.prototype,"scheme"),t([J({type:Boolean,reflect:!0})],me.prototype,"fixed"),t([J({type:String,reflect:!0})],me.prototype,"position"),t([J({type:Number})],me.prototype,"width"),me=t([ae("panel")],me);let be=class extends ue{constructor({maximumLength:e=-1,multiline:t=!1,...n}={}){super(n),this.maximumLength=e,this.multiline=t}render(){return this.multiline?T`
        <textarea
          .value=${le(this.value)}
  ...
  `,t([J({type:Number})],be.prototype,"maximumLength"),t([J({type:Boolean})],be.prototype,"multiline"),be=t([ae("text-field")],be);const ye=re`
  appearance: none;
...
`;let xe=class extends ue{constructor({minimum:e=-1/0,maximum:t=1/0,step:n,range:r=!0,...i}={}){super(i),this.minimum=e,this.maximum=t,this.step=n,this.range=r,this.displayValue=this.value}get inferedMinimum(){return this.range&&this.minimum===-1/0?0:this.minimum}get inferedMaximum(){return this.range&&this.maximum===1/0?100:this.maximum}parse(e){return Math.max(this.minimum,Math.min(this.maximum,parseFloat(e)||0))}render(){return T`
  ...
  `,t([Z('input[type="number"]')],xe.prototype,"$input"),t([J({type:Number,attribute:!1})],xe.prototype,"displayValue"),t([J({type:Number})],xe.prototype,"minimum"),t([J({type:Number})],xe.prototype,"maximum"),t([J({type:Number})],xe.prototype,"step"),t([J({type:Boolean,reflect:!0})],xe.prototype,"range"),xe=t([ae("number-field")],xe);const we=["number","hex","rgb","array","object"],Ee=/^\s*#?([a-f\d]{6}|[a-f\d]{3})\s*$/i,Se=/^\s*rgb(?:a)?\s*\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*(?:,\s*([\d\.]+)\s*)?\)\s*$/i;function Ne(e){return"number"==typeof e?e:parseFloat(e)}function ke(e){if(e)switch(typeof e){case"string":const t=e.match(Se);return!(!t||!t[4]);case"object":return"number"==typeof e[3]||"number"==typeof e.a}return!1}function $e(e){if(e)switch(typeof e){case"string":const t=e.match(Se);if(t&&t[4])return parseFloat(t[4]);break;case"object":let n=NaN;if("number"==typeof e[3]&&(n=Ne(e[3])),"number"==typeof e.a&&(n=Ne(e.a)),!isNaN(n))return n}return 1}function Ce(e,t){switch(typeof e){case"number":if(~~e===e&&e>=0&&e<=16777215)return"number";break;case"string":if(Ee.test(e))return"hex";if(Se.test(e))return"rgb";break;case"object":if(e){if("number"==typeof e.r&&"number"==typeof e.g&&"number"==typeof e.b)return"object";if("number"==typeof e[0]&&"number"==typeof e[1]&&"number"==typeof e[2])return"array"}}return t}function Oe(e,t,n=!1){let r=0,i=0,s=0,a=1;switch(typeof e){case"string":let t=e.match(Ee);if(!t){let t=e.match(Se);t&&(r=parseInt(t[1],10),i=parseInt(t[2],10),s=parseInt(t[3],10),t[4]&&(a=parseFloat(t[4])));break}{let n=t[1];e=parseInt(6===n.length?n:`${n[0]}${n[0]}${n[1]}${n[1]}${n[2]}${n[2]}`,16)}case"number":r=e>>16&255,i=e>>8&255,s=255&e;break;case"object":e&&("r"in e||"g"in e||"b"in e||"a"in e?(r=Ne(e.r)||0,i=Ne(e.g)||0,s=Ne(e.b)||0,a=Ne(e.a)):(r=Ne(e[0])||0,i=Ne(e[1])||0,s=Ne(e[2])||0,a=Ne(e[3])),isNaN(a)&&(a=1))}switch(t){case"number":return r<<16|i<<8|s;case"hex":return`#${(r<<16|i<<8|s).toString(16).padStart(6,"0")}`;case"rgb":return n?`rgba(${r}, ${i}, ${s}, ${a})`:`rgb(${r}, ${i}, ${s})`;case"array":return n?[r,i,s,a]:[r,i,s];case"object":default:return n?{r:r,g:i,b:s,a:a}:{r:r,g:i,b:s}}}let Ae=class extends ue{constructor({value:e,format:t=Ce(e,"rgb"),alpha:n=ke(e),...r}={}){super(r),this.format=t,this.alpha=n,this.set(e),this.displayValue=Oe(this.value,"hex"),this.displayAlpha=$e(this.value)}get includeAlpha(){return this.alpha&&"hex"!==this.format&&"number"!==this.format}parse(e){if(this.includeAlpha){let t=Oe(e,"object",!0);return t.a=Math.max(0,Math.min(1,parseFloat(this.$alpha.value)||0)),t}return e}extract(e){return e.target===this.$alpha?Oe(this.value,"hex"):e.target.value}set(e){return super.set(Oe(e,this.format,this.alpha)),this}render(){const e=Oe(this.value,"hex"),t=`rgba(255, 255, 255, ${1-$e(this.value)})`;return T`
      <input
        type="text"
        .value=${this.displayValue}
        .disabled=${this.disabled}
        @input=${this.input}
        @blur=${()=>{this.displayValue="",requestAnimationFrame(()=>{this.displayValue=Oe(this.value,"hex")})}}
      >
      ...
      <input
        ...
        .value=${e}
        .disabled=${this.disabled}
        style=${`\n          background-color: ${Oe(this.value,"rgb",!0)};\n          background-image: linear-gradient(-45deg, ${t} 50%, transparent 50%, transparent 100%, ${t} 100%, ${t});\n        `}
        @input=${e=>{this.input(e),this.displayValue=Oe(this.value,"hex")}}
      >
      ...
      ${this.includeAlpha?T`
        <div>
          <input
            ...
            .step=${.01}
            @input=${this.input}
            @blur=${()=>{this.displayAlpha=$e(this.value)}}
          >
        </div>
      `:""}
    `}static match({value:e,format:t=Ce(e)}){return function(e){return we.includes(e)}(t)}};Ae.styles=re`
    ${ue.styles}
  ...
  `,t([Z('input[type="number"]')],Ae.prototype,"$alpha"),t([J({type:String,attribute:!1})],Ae.prototype,"displayValue"),t([J({type:Number,attribute:!1})],Ae.prototype,"displayAlpha"),t([J({type:String})],Ae.prototype,"format"),t([J({type:Boolean})],Ae.prototype,"alpha"),Ae=t([ae("color-field")],Ae);let Re=class extends ue{constructor({options:e,humanize:t=!0,...n}={}){super(n),this.options=e,this.humanize=t}get labels(){if(!this.options)return[];let e=Array.isArray(this.options)?this.options.map(e=>`${e}`):Object.keys(this.options);return this.humanize&&e.forEach((t,n)=>{e[n]=oe(t)}),e}get values(){return this.options?Array.isArray(this.options)?this.options:Object.values(this.options):[]}parse(e){return this.values[e]}render(){return T`
      <select
        .disabled=${this.disabled}
        @input=${this.input}
      >
  ...
  `,t([J({type:Object})],Re.prototype,"options"),t([J({type:Boolean})],Re.prototype,"humanize"),Re=t([ae("select-field")],Re);let Me=class extends ue{constructor(){super(...arguments),this.toggle=e=>this.$input.click()}extract(e){return e.target.checked}connectedCallback(){super.connectedCallback(),this.addEventListener("click",this.toggle)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("click",this.toggle)}render(){return T`
      <input
        type="checkbox"
        .checked=${this.value}
        .disabled=${this.disabled}
  ...
  `,t([Z("input")],Me.prototype,"$input"),Me=t([ae("checkbox-field")],Me);let Pe=class extends ue{constructor({value:e,format:t=(e instanceof File?"file":e instanceof Blob?"blob":e instanceof ArrayBuffer?"buffer":e instanceof ReadableStream?"stream":"url"),accept:n=(e instanceof File||e instanceof Blob?e.type:void 0),...r}={}){super(r),this.name="",this.format=t,this.accept=n,this.set(e)}extract(e){const t=e.target.files;return t?t[0]:null}parse(e){if(!e)return;switch(this.format){case"file":return e;case"url":return URL.createObjectURL(e)}const t=new Blob([e],{type:e.type});switch(this.format){case"text":return t.text();case"buffer":return t.arrayBuffer();case"stream":return t.stream()}return t}set(e){return!e&&this.$input&&(this.$input.value=""),e instanceof File||e instanceof Blob?this.name=e.name:"string"==typeof e&&(this.name=e),this.name||(this.name=`Arbitrary ${this.format}`),super.set(e)}clear(){const e=this.value;this.set(void 0),this.dispatchEvent(new de(this.value,e))}render(){return T`
      <input
        type="file"
        .accept=${this.accept||""}
        .disabled=${this.disabled}
  ...
  `,t([J({type:String,attribute:!1})],Te.prototype,"thumbnail"),Te=t([ae("image-field")],Te);let je=class extends ue{constructor({args:e,...t}={}){if(super(t),e){this.parametersController=new fe({label:"Parameters",flat:!0,transparent:!0});const t=2+~~(Math.log(e.length-1)/Math.log(10));e.forEach((e,n)=>{const r=new he({fluid:!0,label:`${n}`.padStart(t," "),...e});r.on("update",e=>e.stopPropagation()),this.parametersController.add(r)})}}trigger(){this.parametersController?this.value(...this.parametersController.childControllers.map(e=>e.value)):this.value()}render(){return T`
