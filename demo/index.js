...
/**
   ...
   * subject to an additional IP rights grant found at
   * http://polymer.github.io/PATENTS.txt
   */const _=` ${i} `;class x{constructor(e,t,n,r){this.strings=e,this.values=t,this.type=n,this.processor=r}getHTML(){const e=this.strings.length-1;let t="",n=!1;for(let r=0;r<e;r++){const e=this.strings[r],a=e.lastIndexOf("\x3c!--");n=(a>-1||n)&&-1===e.indexOf("--\x3e",a+1);const o=u.exec(e);t+=null===o?e+(n?_:s):e.substr(0,o.index)+o[1]+o[2]+"$lit$"+o[3]+i}return t+=this.strings[e],t}getTemplateElement(){const e=document.createElement("template");return e.innerHTML=this.getHTML(),e}}
/**
   * @license
   * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
   * This code may only be used under the BSD style license found at
...
/**
   ...
   * http://polymer.github.io/PATENTS.txt
   */
class{handleAttributeExpressions(e,t,n,r){const i=t[0];if("."===i){return new $(e,t.slice(1),n).parts}if("@"===i)return[new R(e,t.slice(1),r.eventContext)];if("?"===i)return[new C(e,t.slice(1),n)];return new S(e,t,n).parts}handleTextExpression(e){return new k(e)}};
/**
   * @license
   * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
   * This code may only be used under the BSD style license found at
   ...
   * subject to an additional IP rights grant found at
   * http://polymer.github.io/PATENTS.txt
   */"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.2.1");const B=(e,...t)=>new x(e,t,"html",L)
/**
   * @license
   * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
   * This code may only be used under the BSD style license found at
...
(window.litElementVersions||(window.litElementVersions=[])).push("2.3.1");const re={};class ie extends W{static getStyles(){return this.styles}static _getUniqueStyles(){if(this.hasOwnProperty(JSCompiler_renameProperty("_styles",this)))return;const e=this.getStyles();if(void 0===e)this._styles=[];else if(Array.isArray(e)){const t=(e,n)=>e.reduceRight((e,n)=>Array.isArray(n)?t(n,e):(e.add(n),e),n),n=t(e,new Set),r=[];n.forEach(e=>r.unshift(e)),this._styles=r}else this._styles=[e]}initialize(){super.initialize(),this.constructor._getUniqueStyles(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow({mode:"open"})}adoptStyles(){const e=this.constructor._styles;0!==e.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?Q?this.renderRoot.adoptedStyleSheets=e.map(e=>e.styleSheet):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(e.map(e=>e.cssText),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(e){const t=this.render();super.update(e),t!==re&&this.constructor.render(t,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach(e=>{const t=document.createElement("style");t.textContent=e.cssText,this.renderRoot.appendChild(t)}))}render(){return re}}ie.finalized=!0,ie.render=(e,t,n)=>{if(!n||"object"!=typeof n||!n.scopeName)throw new Error("The `scopeName` option is required.");const i=n.scopeName,s=j.has(t),a=D&&11===t.nodeType&&!!t.host,o=a&&!V.has(i),l=o?document.createDocumentFragment():t;if(((e,t,n)=>{let i=j.get(t);void 0===i&&(r(t,t.firstChild),j.set(t,i=new k(Object.assign({templateFactory:P},n))),i.appendInto(t)),i.setValue(e),i.commit()})(e,l,Object.assign({templateFactory:z(i)},n)),o){const e=j.get(l);j.delete(l);const n=e.value instanceof v?e.value.template:void 0;H(i,l,n),r(t,t.firstChild),t.appendChild(l),j.set(t,e)}!s&&a&&window.ShadyCSS.styleElement(t.host)};class se extends ie{on(e,t,...n){return this.addEventListener(e,t,...n),this}off(e,t,...n){return this.removeEventListener(e,t,...n),this}}se.styles=ne`
  ...
  `;class ae extends Event{constructor(e,t){super("update",{composed:!0}),this.value=e,this.previous=t}}class oe extends se{constructor({value:e,disabled:t=!1}={}){super(),this.set(e),this.disabled=t}input(e){e.stopPropagation();const t=this.value;Promise.resolve(this.parse(this.extract(e))).then(e=>this.set(e).dispatchEvent(new ae(this.value,t)))}extract(e){return e.target.value}parse(e){return e}set(e){return this.value=e,this}static match(e){return!1}static register(e,t){if(this.types.find(t=>e===t.name))throw new Error(`Field type ${e} has already been registered`);return this.types.unshift({type:t,name:e}),this}static use(e){return Object.entries(e).forEach(({0:e,1:t})=>this.register(e,t)),this}static from(e){return new((this.types.find(({type:t,name:n})=>n===e.field||t.match(e))||this.types[this.types.length-1]).type)(e)}}oe.types=[],oe.styles=ne`
    ${se.styles}
  ...
  `,t([X()],oe.prototype,"value"),t([X({type:Boolean})],oe.prototype,"disabled");const le=e=>t=>{customElements.define("gui-"+e,t)};function ce(e){return function(e){return`${e[0].toUpperCase()}${e.slice(1)}`}(function(e,t){return e.replace(/([^A-Z\d])([A-Z\d]+)/g,`$1${t}$2`).toLowerCase()}(""+e," ")).replace(/[-_\s]+/g," ")}function de(e){return void 0===e?"":""+e}class ue extends se{constructor({target:e,listen:t=!1,label:n}={}){super(),this.target=e,this.listen=t,this.label=n}attach(e=this.target){return this.dettach(),this.target=e,this}dettach(){return this}}ue.styles=ne`
    ${se.styles}
  ...
  `,t([X({type:String})],ue.prototype,"label");let pe=class extends ue{constructor({field:e,property:t,inline:n=!0,fluid:r=!1,target:i,listen:s=!1,label:a=(t?ce(""+t):void 0),value:o=(i&&t?i[t]:void 0),...l}){super({target:i,listen:s,label:a}),this.focused=!1,this.commit=this.commit.bind(this),this.property=t,this.inline=n,this.fluid=r,this.field=e instanceof oe?e:oe.from({field:e,value:o,...l}),this.field.on("focus",()=>{this.focused=!0}),this.field.on("blur",()=>{this.focused=!1}),this.attach(),this.value=o}get value(){return this.field.value}set value(e){this.field.set(e),this.commit(new ae(e,void 0))}commit(e){this.target&&this.property&&(this.target[this.property]=e.value)}attach(e=this.target){if(super.attach(e),this.target&&this.property&&(this.field.on("update",this.commit),this.value=this.target[this.property],this.listen)){let e;this.descriptor=Object.getOwnPropertyDescriptor(this.target,this.property)||{value:void 0};const{get:t=(()=>e),set:n=(t=>{e=t})}=this.descriptor;try{Object.defineProperty(this.target,this.property,{get:t,set:e=>{const r=t();this.field.set(e),n.call(this.target,e),this.dispatchEvent(new ae(e,r))}})}catch(e){throw this.descriptor=void 0,new Error("Unable to initialize property setter: "+e)}}return this}dettach(){if(super.dettach(),this.field.off("update",this.commit),this.target&&this.property&&this.descriptor){"value"in this.descriptor&&(this.descriptor.value=this.value);try{Object.defineProperty(this.target,this.property,this.descriptor),this.descriptor=void 0}catch(e){throw new Error("Unable to dispose property setter: "+e)}}return this}render(){return B`${this.label?B`<span @mousedown=${e=>e.preventDefault()}>
          ${this.label}
  ...
  `,t([X({type:String,reflect:!0})],fe.prototype,"scheme"),t([X({type:Boolean,reflect:!0})],fe.prototype,"fixed"),t([X({type:String,reflect:!0})],fe.prototype,"position"),t([X({type:Number})],fe.prototype,"width"),fe=t([le("panel")],fe);let me=class extends oe{constructor({maximumLength:e=-1,multiline:t=!1,...n}={}){super(n),this.maximumLength=e,this.multiline=t}render(){return this.multiline?B`
        <textarea
          .value=${de(this.value)}
...
`,ve=ne`
  ...
  height: 2px;
  border-radius: 2px;
`;let _e=class extends oe{constructor({minimum:e=-1/0,maximum:t=1/0,step:n,range:r=!0,...i}={}){super(i),this.minimum=e,this.maximum=t,this.step=n,this.range=r,this.displayValue=this.value}get inferedMinimum(){return this.range&&this.minimum===-1/0?0:this.minimum}get inferedMaximum(){return this.range&&this.maximum===1/0?100:this.maximum}parse(e){return Math.max(this.minimum,Math.min(this.maximum,parseFloat(e)||0))}set(e){return super.set(e),this.displayValue=this.value,this}render(){return B`
      ${this.range?B`
        <input
          type="range"
          .value=${this.value}
  ...
  `,t([J('input[type="number"]')],_e.prototype,"$input"),t([X({type:Number,attribute:!1})],_e.prototype,"displayValue"),t([X({type:Number})],_e.prototype,"minimum"),t([X({type:Number})],_e.prototype,"maximum"),t([X({type:Number})],_e.prototype,"step"),t([X({type:Boolean,reflect:!0})],_e.prototype,"range"),_e=t([le("number-field")],_e);const xe=["number","hex","rgb","array","object"],we=/^\s*#?([a-f\d]{6}|[a-f\d]{3})\s*$/i,Ee=/^\s*rgb(?:a)?\s*\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*(?:,\s*([\d\.]+)\s*)?\)\s*$/i;function Se(e){return"number"==typeof e?e:parseFloat(e)}function Ne(e){if(e)switch(typeof e){case"string":const t=e.match(Ee);return!(!t||!t[4]);case"object":return"number"==typeof e[3]||"number"==typeof e.a}return!1}function ke(e){if(e)switch(typeof e){case"string":const t=e.match(Ee);if(t&&t[4])return parseFloat(t[4]);break;case"object":let n=NaN;if("number"==typeof e[3]&&(n=Se(e[3])),"number"==typeof e.a&&(n=Se(e.a)),!isNaN(n))return n}return 1}function Ce(e,t){switch(typeof e){case"number":if(~~e===e&&e>=0&&e<=16777215)return"number";break;case"string":if(we.test(e))return"hex";if(Ee.test(e))return"rgb";break;case"object":if(e){if("number"==typeof e.r&&"number"==typeof e.g&&"number"==typeof e.b)return"object";if("number"==typeof e[0]&&"number"==typeof e[1]&&"number"==typeof e[2])return"array"}}return t}function $e(e,t,n=!1){let r=0,i=0,s=0,a=1;switch(typeof e){case"string":const t=e.match(we);if(!t){const t=e.match(Ee);t&&(r=parseInt(t[1],10),i=parseInt(t[2],10),s=parseInt(t[3],10),t[4]&&(a=parseFloat(t[4])));break}{const n=t[1];e=parseInt(6===n.length?n:`${n[0]}${n[0]}${n[1]}${n[1]}${n[2]}${n[2]}`,16)}case"number":r=e>>16&255,i=e>>8&255,s=255&e;break;case"object":e&&("r"in e||"g"in e||"b"in e||"a"in e?(r=Se(e.r)||0,i=Se(e.g)||0,s=Se(e.b)||0,a=Se(e.a)):(r=Se(e[0])||0,i=Se(e[1])||0,s=Se(e[2])||0,a=Se(e[3])),isNaN(a)&&(a=1))}switch(t){case"number":return r<<16|i<<8|s;case"hex":return"#"+(r<<16|i<<8|s).toString(16).padStart(6,"0");case"rgb":return n?`rgba(${r}, ${i}, ${s}, ${a})`:`rgb(${r}, ${i}, ${s})`;case"array":return n?[r,i,s,a]:[r,i,s];case"object":default:return n?{r:r,g:i,b:s,a:a}:{r:r,g:i,b:s}}}let Oe=class extends oe{constructor({value:e,format:t=Ce(e,"rgb"),alpha:n=Ne(e),...r}={}){super(r),this.format=t,this.alpha=n,this.set(e),this.displayValue=$e(this.value,"hex"),this.displayAlpha=ke(this.value)}get includeAlpha(){return this.alpha&&"hex"!==this.format&&"number"!==this.format}parse(e){if(this.includeAlpha){const t=$e(e,"object",!0);return t.a=Math.max(0,Math.min(1,parseFloat(this.$alpha.value)||0)),t}return e}extract(e){return e.target===this.$alpha?$e(this.value,"hex"):e.target.value}set(e){return super.set($e(e,this.format,this.alpha)),this}render(){const e=$e(this.value,"hex"),t=`rgba(255, 255, 255, ${1-ke(this.value)})`;return B`
      <input
        type="text"
        .value=${this.displayValue}
        .disabled=${this.disabled}
        @input=${this.input}
        @blur=${()=>{this.displayValue="",requestAnimationFrame(()=>{this.displayValue=$e(this.value,"hex")})}}
      >
      ...
      <input
        ...
        .value=${e}
        .disabled=${this.disabled}
        style=${`\n          background-color: ${$e(this.value,"rgb",!0)};\n          background-image: linear-gradient(-45deg, ${t} 50%, transparent 50%, transparent 100%, ${t} 100%, ${t});\n        `}
        @input=${e=>{this.input(e),requestAnimationFrame(()=>{this.displayValue=$e(this.value,"hex")})}}
      >
      ...
      `:""}
    `}static match({value:e,format:t=Ce(e)}){return function(e){return xe.includes(e)}(t)}};Oe.styles=ne`
    ${oe.styles}
  ...
  `,t([J('input[type="number"]')],Oe.prototype,"$alpha"),t([X({type:String,attribute:!1})],Oe.prototype,"displayValue"),t([X({type:Number,attribute:!1})],Oe.prototype,"displayAlpha"),t([X({type:String})],Oe.prototype,"format"),t([X({type:Boolean})],Oe.prototype,"alpha"),Oe=t([le("color-field")],Oe);let Ae=class extends oe{constructor({options:e,humanize:t=!0,...n}={}){super(n),this.options=e,this.humanize=t}get labels(){if(!this.options)return[];const e=Array.isArray(this.options)?this.options.map(e=>""+e):Object.keys(this.options);return this.humanize&&e.forEach((t,n)=>{e[n]=ce(t)}),e}get values(){return this.options?Array.isArray(this.options)?this.options:Object.values(this.options):[]}parse(e){return this.values[e]}render(){return B`
      <select
        .disabled=${this.disabled}
        @input=${this.input}
      >
    ...
    `}static match({options:e}){return e&&("object"==typeof e||Array.isArray(e))}};Ae.styles=ne`
    ${oe.styles}
  ...
  `,t([X({type:Object})],Ae.prototype,"options"),t([X({type:Boolean})],Ae.prototype,"humanize"),Ae=t([le("select-field")],Ae);let Re=class extends oe{constructor(){super(...arguments),this.toggle=()=>this.$input.click()}extract(e){return e.target.checked}connectedCallback(){super.connectedCallback(),this.addEventListener("click",this.toggle)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("click",this.toggle)}render(){return B`
      <input
        type="checkbox"
        .checked=${this.value}
        .disabled=${this.disabled}
  ...
  `,t([J("input")],Re.prototype,"$input"),Re=t([le("checkbox-field")],Re);let Me=class extends oe{constructor({value:e,format:t=(e instanceof File?"file":e instanceof Blob?"blob":e instanceof ArrayBuffer?"buffer":e instanceof ReadableStream?"stream":"url"),accept:n=(e instanceof File||e instanceof Blob?e.type.replace(/^(image|audio|video)\/.*$/,"$1/*"):void 0),...r}={}){super(r),this.name="",this.format=t,this.accept=n,this.set(e)}extract(e){const t=e.target.files;return t?t[0]:null}parse(e){if(e){switch(this.format){case"url":return URL.createObjectURL(e);case"text":return e.text();case"buffer":return e.arrayBuffer();case"stream":return e.stream()}return e}}set(e){return!e&&this.$input&&(this.$input.value=""),e instanceof File?this.name=e.name:"string"==typeof e&&(this.name=e),this.name||(this.name="Arbitrary "+this.format),super.set(e)}clear(){const e=this.value;this.set(void 0),this.dispatchEvent(new ae(this.value,e))}render(){return B`
      <input
        type="file"
        .accept=${this.accept||""}
        .disabled=${this.disabled}
      ...
      ${this.value?B`<span
        @click=${this.clear}
      ></span>`:""}
    `}static match({value:e}){return e instanceof Blob||e instanceof ArrayBuffer||e instanceof ReadableStream}};Me.styles=ne`
    ${oe.styles}
  ...
  `,t([J("input")],Me.prototype,"$input"),t([X({type:String})],Me.prototype,"format"),t([X({type:String})],Me.prototype,"accept"),Me=t([le("file-field")],Me);let Pe=class extends Me{constructor(e={}){super({...e,accept:"image/*"})}set(e){return this.thumbnail&&(URL.revokeObjectURL(this.thumbnail),this.thumbnail=void 0),"string"==typeof e?this.thumbnail=e:(e instanceof Blob||e instanceof File)&&(this.thumbnail=URL.createObjectURL(e)),super.set(e)}render(){return B`
    ...
    `}static match(e){const t=e.value;return t&&"string"==typeof t&&/\.(png|jpe?g|gif|svg)$/i.test(t)||t instanceof Blob&&"image/"===t.type.slice(0,6)}};Pe.styles=ne`
    ${Me.styles}
  ...
  `,t([X({type:String,attribute:!1})],Pe.prototype,"thumbnail"),Pe=t([le("image-field")],Pe);let Te=class extends oe{constructor({args:e,...t}={}){if(super(t),e){this.parametersController=new ge({label:"Parameters",flat:!0,transparent:!0});const t=2+~~(Math.log(e.length-1)/Math.log(10));e.forEach((e,n)=>{const r=new pe({fluid:!0,label:(""+n).padStart(t," "),...e});r.on("update",e=>e.stopPropagation()),this.parametersController.add(r)})}}trigger(){this.parametersController?this.value(...this.parametersController.childControllers.map(e=>e.value)):this.value()}render(){return B`
