...
/**
   ...
   * subject to an additional IP rights grant found at
   * http://polymer.github.io/PATENTS.txt
   */const x=window.trustedTypes&&trustedTypes.createPolicy("lit-html",{createHTML:e=>e}),_=` ${i} `;class w{constructor(e,t,n,r){this.strings=e,this.values=t,this.type=n,this.processor=r}getHTML(){const e=this.strings.length-1;let t="",n=!1;for(let r=0;r<e;r++){const e=this.strings[r],o=e.lastIndexOf("\x3c!--");n=(o>-1||n)&&-1===e.indexOf("--\x3e",o+1);const a=u.exec(e);t+=null===a?e+(n?_:s):e.substr(0,a.index)+a[1]+a[2]+"$lit$"+a[3]+i}return t+=this.strings[e],t}getTemplateElement(){const e=document.createElement("template");let t=this.getHTML();return void 0!==x&&(t=x.createHTML(t)),e.innerHTML=t,e}}
/**
   * @license
   * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
   * This code may only be used under the BSD style license found at
...
/**
   ...
   * http://polymer.github.io/PATENTS.txt
   */
class{handleAttributeExpressions(e,t,n,r){const i=t[0];if("."===i){return new O(e,t.slice(1),n).parts}if("@"===i)return[new M(e,t.slice(1),r.eventContext)];if("?"===i)return[new $(e,t.slice(1),n)];return new N(e,t,n).parts}handleTextExpression(e){return new C(e)}};
/**
   * @license
   * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
   * This code may only be used under the BSD style license found at
   ...
   * subject to an additional IP rights grant found at
   * http://polymer.github.io/PATENTS.txt
   */"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.4.1");const U=(e,...t)=>new w(e,t,"html",B)
/**
   * @license
   * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
   * This code may only be used under the BSD style license found at
...
/**
   ...
   * http://polymer.github.io/PATENTS.txt
   */
const X=(e,t)=>"method"===t.kind&&t.descriptor&&!("value"in t.descriptor)?Object.assign(Object.assign({},t),{finisher(n){n.createProperty(t.key,e)}}):{kind:"field",key:Symbol(),placement:"own",descriptor:{},initializer(){"function"==typeof t.initializer&&(this[t.key]=t.initializer.call(this))},finisher(n){n.createProperty(t.key,e)}};function J(e){return(t,n)=>void 0!==n?((e,t,n)=>{t.constructor.createProperty(n,e)})(e,t,n):X(e,t)}function Z(e,t){return(n,r)=>{const i={get(){return this.renderRoot.querySelector(e)},enumerable:!0,configurable:!0};if(t){const t=void 0!==r?r:n.key,s="symbol"==typeof t?Symbol():"__"+t;i.get=function(){return void 0===this[s]&&(this[s]=this.renderRoot.querySelector(e)),this[s]}}return void 0!==r?Y(i,n,r):Q(i,n)}}const Y=(e,t,n)=>{Object.defineProperty(t,n,e)},Q=(e,t)=>({kind:"method",placement:"prototype",key:t.key,descriptor:e})
/**
  @license
...
/**
   ...
   * http://polymer.github.io/PATENTS.txt
   */
(window.litElementVersions||(window.litElementVersions=[])).push("2.5.1");const ie={};class se extends G{static getStyles(){return this.styles}static _getUniqueStyles(){if(this.hasOwnProperty(JSCompiler_renameProperty("_styles",this)))return;const e=this.getStyles();if(Array.isArray(e)){const t=(e,n)=>e.reduceRight((e,n)=>Array.isArray(n)?t(n,e):(e.add(n),e),n),n=t(e,new Set),r=[];n.forEach(e=>r.unshift(e)),this._styles=r}else this._styles=void 0===e?[]:[e];this._styles=this._styles.map(e=>{if(e instanceof CSSStyleSheet&&!ee){const t=Array.prototype.slice.call(e.cssRules).reduce((e,t)=>e+t.cssText,"");return new ne(String(t),te)}return e})}initialize(){super.initialize(),this.constructor._getUniqueStyles(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow(this.constructor.shadowRootOptions)}adoptStyles(){const e=this.constructor._styles;0!==e.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?ee?this.renderRoot.adoptedStyleSheets=e.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(e.map(e=>e.cssText),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(e){const t=this.render();super.update(e),t!==ie&&this.constructor.render(t,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach(e=>{const t=document.createElement("style");t.textContent=e.cssText,this.renderRoot.appendChild(t)}))}render(){return ie}}se.finalized=!0,se.render=(e,t,n)=>{if(!n||"object"!=typeof n||!n.scopeName)throw new Error("The `scopeName` option is required.");const i=n.scopeName,s=L.has(t),o=z&&11===t.nodeType&&!!t.host,a=o&&!H.has(i),l=a?document.createDocumentFragment():t;if(((e,t,n)=>{let i=L.get(t);void 0===i&&(r(t,t.firstChild),L.set(t,i=new C(Object.assign({templateFactory:P},n))),i.appendInto(t)),i.setValue(e),i.commit()})(e,l,Object.assign({templateFactory:I(i)},n)),a){const e=L.get(l);L.delete(l);const n=e.value instanceof v?e.value.template:void 0;F(i,l,n),r(t,t.firstChild),t.appendChild(l),L.set(t,e)}!s&&o&&window.ShadyCSS.styleElement(t.host)},se.shadowRootOptions={mode:"open"};class oe extends se{on(e,t,...n){return this.addEventListener(e,t,...n),this}off(e,t,...n){return this.removeEventListener(e,t,...n),this}}oe.styles=re`
    :host {
      display: block;
  ...
  `;class ae extends Event{constructor(e,t){super("update",{composed:!0}),this.value=e,this.previous=t}}class le extends oe{constructor({value:e,disabled:t=!1}={}){super(),this.set(e),this.disabled=t}input(e){e.stopPropagation();const t=this.value;Promise.resolve(this.parse(this.extract(e))).then(e=>this.set(e).dispatchEvent(new ae(this.value,t)))}extract(e){return e.target.value}parse(e){return e}set(e){return this.value=e,this}static match(e){return!1}static register(e,t){if(this.types.find(t=>e===t.name))throw new Error(`Field type ${e} has already been registered`);return this.types.unshift({type:t,name:e}),this}static use(e){return Object.entries(e).forEach(({0:e,1:t})=>this.register(e,t)),this}static from(e){return new((this.types.find(({type:t,name:n})=>n===e.field||t.match(e))||this.types[this.types.length-1]).type)(e)}}le.types=[],le.styles=re`
    ${oe.styles}
...
`;let _e=class extends le{constructor({minimum:e=-1/0,maximum:t=1/0,step:n,range:r=!0,...i}={}){super(i),this.minimum=e,this.maximum=t,this.step=n,this.range=r,this.displayValue=this.value}get inferedMinimum(){return this.range&&this.minimum===-1/0?0:this.minimum}get inferedMaximum(){return this.range&&this.maximum===1/0?100:this.maximum}parse(e){return Math.max(this.minimum,Math.min(this.maximum,parseFloat(e)||0))}set(e){return super.set(e),this.displayValue=this.value,this}render(){return U`
  ...
  `,t([Z('input[type="number"]')],_e.prototype,"$input"),t([J({type:Number,attribute:!1})],_e.prototype,"displayValue"),t([J({type:Number})],_e.prototype,"minimum"),t([J({type:Number})],_e.prototype,"maximum"),t([J({type:Number})],_e.prototype,"step"),t([J({type:Boolean,reflect:!0})],_e.prototype,"range"),_e=t([ce("number-field")],_e);const we=["number","hex","rgb","array","object"],Ee=/^\s*#?([a-f\d]{6}|[a-f\d]{3})\s*$/i,Se=/^\s*rgb(?:a)?\s*\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*(?:,\s*([\d\.]+)\s*)?\)\s*$/i;function Ne(e){return"number"==typeof e?e:parseFloat(e)}function ke(e){if(e)switch(typeof e){case"string":const t=e.match(Se);return!(!t||!t[4]);case"object":return"number"==typeof e[3]||"number"==typeof e.a}return!1}function Ce(e){if(e)switch(typeof e){case"string":const t=e.match(Se);if(t&&t[4])return parseFloat(t[4]);break;case"object":let n=NaN;if("number"==typeof e[3]&&(n=Ne(e[3])),"number"==typeof e.a&&(n=Ne(e.a)),!isNaN(n))return n}return 1}function $e(e,t){switch(typeof e){case"number":if(~~e===e&&e>=0&&e<=16777215)return"number";break;case"string":if(Ee.test(e))return"hex";if(Se.test(e))return"rgb";break;case"object":if(e){if("number"==typeof e.r&&"number"==typeof e.g&&"number"==typeof e.b)return"object";if("number"==typeof e[0]&&"number"==typeof e[1]&&"number"==typeof e[2])return"array"}}return t}function Oe(e,t,n=!1){let r=0,i=0,s=0,o=1;switch(typeof e){case"string":const t=e.match(Ee);if(!t){const t=e.match(Se);t&&(r=parseInt(t[1],10),i=parseInt(t[2],10),s=parseInt(t[3],10),t[4]&&(o=parseFloat(t[4])));break}{const n=t[1];e=parseInt(6===n.length?n:`${n[0]}${n[0]}${n[1]}${n[1]}${n[2]}${n[2]}`,16)}case"number":r=e>>16&255,i=e>>8&255,s=255&e;break;case"object":e&&("r"in e||"g"in e||"b"in e||"a"in e?(r=Ne(e.r)||0,i=Ne(e.g)||0,s=Ne(e.b)||0,o=Ne(e.a)):(r=Ne(e[0])||0,i=Ne(e[1])||0,s=Ne(e[2])||0,o=Ne(e[3])),isNaN(o)&&(o=1))}switch(t){case"number":return r<<16|i<<8|s;case"hex":return"#"+(r<<16|i<<8|s).toString(16).padStart(6,"0");case"rgb":return n?`rgba(${r}, ${i}, ${s}, ${o})`:`rgb(${r}, ${i}, ${s})`;case"array":return n?[r,i,s,o]:[r,i,s];case"object":default:return n?{r:r,g:i,b:s,a:o}:{r:r,g:i,b:s}}}let Ae=class extends le{constructor({value:e,format:t=$e(e,"rgb"),alpha:n=ke(e),...r}={}){super(r),this.format=t,this.alpha=n,this.set(e),this.displayValue=Oe(this.value,"hex"),this.displayAlpha=Ce(this.value)}get includeAlpha(){return this.alpha&&"hex"!==this.format&&"number"!==this.format}parse(e){if(this.includeAlpha){const t=Oe(e,"object",!0);return t.a=Math.max(0,Math.min(1,parseFloat(this.$alpha.value)||0)),t}return e}extract(e){return e.target===this.$alpha?Oe(this.value,"hex"):e.target.value}set(e){return super.set(Oe(e,this.format,this.alpha)),this}render(){const e=Oe(this.value,"hex"),t=`rgba(255, 255, 255, ${1-Ce(this.value)})`;return U`
      <input
        type="text"
        .value=${this.displayValue}
        .disabled=${this.disabled}
      ...
      <input
        ...
        @input=${e=>{this.input(e),requestAnimationFrame(()=>{this.displayValue=Oe(this.value,"hex")})}}
      >
      ...
      `:""}
    `}static match({value:e,format:t=$e(e)}){return function(e){return we.includes(e)}(t)}};Ae.styles=re`
    ${le.styles}
  ...
  `,t([Z('input[type="number"]')],Ae.prototype,"$alpha"),t([J({type:String,attribute:!1})],Ae.prototype,"displayValue"),t([J({type:Number,attribute:!1})],Ae.prototype,"displayAlpha"),t([J({type:String})],Ae.prototype,"format"),t([J({type:Boolean})],Ae.prototype,"alpha"),Ae=t([ce("color-field")],Ae);let Re=class extends le{constructor({options:e,humanize:t=!0,...n}={}){super(n),this.options=e,this.humanize=t}get labels(){if(!this.options)return[];const e=Array.isArray(this.options)?this.options.map(e=>""+e):Object.keys(this.options);return this.humanize&&e.forEach((t,n)=>{e[n]=de(t)}),e}get values(){return this.options?Array.isArray(this.options)?this.options:Object.values(this.options):[]}parse(e){return this.values[e]}render(){return U`
      <select
        .disabled=${this.disabled}
        @input=${this.input}
      >
